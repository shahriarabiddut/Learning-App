  ...
  return (
    <section className="py-16 md:py-24 bg-white dark:bg-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-40">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-teal-400/10 dark:bg-teal-600/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-emerald-400/10 dark:bg-emerald-600/5 rounded-full blur-3xl"></div>
      </div>
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <Link href="/articles">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center gap-2 bg-white dark:bg-slate-800 border-2 border-emerald-600 dark:border-emerald-500 text-emerald-700 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-950 px-6 py-3 rounded-xl font-semibold shadow-lg transition-all duration-300"
              >
                View All
            ...
            {data?.data?.map((post: Post, index: number) => (
              ...
              >
                <Link href={`/post/${post.slug || post.id}`}>
                  <Card className="h-full hover:shadow-2xl hover:shadow-emerald-500/10 transition-all duration-500 cursor-pointer overflow-hidden group border-2 border-emerald-100 dark:border-emerald-900/30 hover:border-emerald-300 dark:hover:border-emerald-700 hover:translate-y-[-8px] bg-white dark:bg-slate-800/50 backdrop-blur-sm">
